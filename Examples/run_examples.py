...
if __name__ == '__main__':
    ...
    protect_pdf_document.run() #ERROR invalid password
    render_to_pdf.run()
    ...
    # set_image_size_limits.run() #Parameter is not valid

    # # Rendering Archive files
    # get_view_info_for_archive_file.run() #Object reference not set
    ...
    # specify_filename_when_rendering_archive_files.run() #bject reference not set
    
    # # Rendering CAD drawings
    # adjust_output_image_size.run() #CAD document rendering failed
    # get_view_info_for_cad_drawing.run()
    # render_all_layouts.run() #CAD document rendering failed
    # render_layers.run() #CAD document rendering failed
    # render_single_layout.run() #CAD document rendering failed
    # rendering_cf2.run() #CAD document rendering failed
    # rendering_hpg.run() #Could not load file. File is corrupted or damaged.
    # rendering_igs.run() #CAD document rendering failed
    # rendering_obj.run() #CAD document rendering failed
    # rendering_pc3_files.run() #CAD document rendering failed
    # rendering_plt.run() #Could not load file. File is corrupted or damaged.
    # set_image_background_color.run() #CAD document rendering failed
    # split_drawing_into_tiles.run() #CAD document rendering failed
    ...
    # rendering_apng.run()
    # rendering_cdr.run() #Image export failed.
    # rendering_cmx.run() #Image export failed.
    # rendering_emz_and_emf.run() #Required font 'Times New Roman'
    # rendering_fodg_and_odg.run() #Image export failed.
    # rendering_svgz.run() #Image export failed.   
    # rendering_tga.run()
    # rendering_wmz_wmf.run() #Image export failed.
    ...
    # rendering_visio_documents_figures.run() #Image loading failed.
