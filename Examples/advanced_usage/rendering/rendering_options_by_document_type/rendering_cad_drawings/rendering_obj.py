...
def render_document(output_directory, input_file, output_format):
    page_file_path_format = join(output_directory, f"obj_result.{output_format.lower()}")
...
def run():
    ...
    # Render to HTML
    render_document(output_directory, test_files.sample_obj, "HTML")

    # Render to JPG
    render_document(output_directory, test_files.sample_obj, "JPG")

    # Render to PNG
    render_document(output_directory, test_files.sample_obj, "PNG")

    # Render to PDF
    render_document(output_directory, test_files.sample_obj, "PDF")
